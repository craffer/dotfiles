...
# Generated by Powerlevel10k configuration wizard on 2019-12-18 at 22:46 EST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%02F'  # grey foreground
      local   modified='%03F'  # grey foreground
      local  untracked='%06F'  # grey foreground
      local conflicted='%01F'  # grey foreground
    fi
    ...
    (( VCS_STATUS_COMMITS_AHEAD  )) && res+="%8F${VCS_STATUS_COMMITS_AHEAD}⇡"
